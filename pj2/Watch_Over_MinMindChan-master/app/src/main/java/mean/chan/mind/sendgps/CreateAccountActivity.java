...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (nameString.equals("") ||
            ...
            //Password not match
            MyAlert myAlert = new MyAlert(CreateAccountActivity.this);
            myAlert.myDialog("Password don't match.","Please try again.");
            ...
            //Non check
            MyAlert myAlert = new MyAlert(CreateAccountActivity.this);
            myAlert.myDialog("Don't select gender.","Please select gender.");
        }
    ...
    private void upLoadValueToServer() {
        ...
        try {
            ...
            if (Boolean.parseBoolean(postValueToParent.get())) {
                ...
                MyAlert myAlert = new MyAlert(CreateAccountActivity.this);
                myAlert.myDialog("Upload False","Can't upload data.");
            }
