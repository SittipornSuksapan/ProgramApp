...
Class Password_reset_model extends CI_Model {
    ...
    public function reset_password() {
        $email = isset($_POST['m_user']) ? $_POST['m_user'] : null;
    ...
    public function data_check() {
        $user = isset($_POST['m_user']) ? trim($_POST['m_user'], ' ') : null;
    ...
    private function send_mail($user_data) {
        ...
        $mail_message = $this->load->view($this->access_module . '/mail_template', array(
