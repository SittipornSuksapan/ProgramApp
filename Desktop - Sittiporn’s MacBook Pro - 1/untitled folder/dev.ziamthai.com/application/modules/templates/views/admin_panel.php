...
//-- defined variables
$apps_name = isset($apps_name) ? $apps_name : 'admin_panel';
...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('asset/ziamthai/css/admin_panel.css?_=' . time()); ?>" rel="stylesheet">
        ...
        <script src="<?php echo base_url('asset/ziamthai/js/admin_panel/admin_panel.js?_=' . time()); ?>" type="text/javascript"></script>
    </head>
        ...
        if (!$login_user_id) {
            ...
            <div class="container" style="margin-bottom:20px;">
                ...
                <div class="col-xs-6" style="text-align:center;">
                    <a href="<?php echo site_url($apps_name); ?>">
                        <img src="<?php echo base_url('asset/ziamthai/img/logo.png'); ?>" class="img-fluid">
                    </a>
                </div>

                <div class="col-xs-3">
                    <button type="button" class="hidden-md-up btn btn-link btn-block" onclick="layout_2col(null, '#layout_panel');">
            ...
            <div id="layout_panel" class="container">
                ...
                <div id="layout_content" data-layout-2col="one" class="col-xs-12 col-md-8 col-lg-9">
                    <?php echo $content; ?>
                </div>

                <div id="layout_aside" data-layout-2col="two" class="col-xs-12 col-md-4 col-lg-3">
                    ...
                    <div class="card">
                        <div class="card-header" style="position:relative;">
                            ...
                            <a href="<?php echo site_url($apps_name . '/home/logout'); ?>" onclick="return confirm('<?php echo $this->lang->line('confirm_logout'); ?>');" class="btn btn-link" style="position:absolute;top:6px;right:0;">
                        ...
                        <div class="card-block">
                            <?php
                            if (is_array($sidebar)) {
                                if (!empty($sidebar['lang'])) {
                                    $this->load->language($sidebar['lang']);
                                }

                                if (!empty($sidebar['view'])) {
																	if (!empty($sidebar['sidebar'])) {
                                    $this->load->view($sidebar['view'],$sidebar['sidebar']);
																	} else {
                                    $this->load->view($sidebar['view']);
																	}
                                }
                            } else {
                                echo $sidebar;
