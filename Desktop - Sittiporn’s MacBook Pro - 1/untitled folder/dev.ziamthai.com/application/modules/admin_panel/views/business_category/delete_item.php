...
<?php
	$sBackClick = sprintf("%s%d", base_url('index.php/admin_panel/business_category/list_item/?&id='),$parent['bsth_pid']); 
...
<div class="card card-outline-secondary">
	...
	<div class="card-block">
		<div class="card">
			<div class="card-header h4 bg-danger text-white">Delete Biz Category</div>
			<div class="card-block">
...
<?php } }?>
				...
				<div class="row">
					<div class="col-md-12 text-md-right">
						<button name='btnDelete' class="btn btn-danger" id="btnDelete"><i class="fa fa-floppy-o"></i> Delete</button>
					</div>
				</div>
			</div>
		</div>
...
<?php		if ($data['result']==true) {?>
		window.location.href='<?php echo base_url('index.php/admin_panel/business_category/list_item/?&id=').$data['bsth_pid'];?>';
<?php } } ?>
</script>