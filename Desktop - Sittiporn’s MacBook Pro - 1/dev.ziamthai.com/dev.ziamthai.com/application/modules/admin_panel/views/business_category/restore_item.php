...
<?php
	$sBackClick = sprintf("%s%d", base_url('index.php/admin_panel/business_category/list_item/?&id='),$data['bsth_pid']); 
...
<div class="card card-outline-secondary">
	...
	<div class="card-block">
		<div class="card">
			<div class="card-header h4 bg-info text-white">Edit Biz Category in '<?php echo $parent['bsth_title'];?>'</div>
			<div class="card-block">
