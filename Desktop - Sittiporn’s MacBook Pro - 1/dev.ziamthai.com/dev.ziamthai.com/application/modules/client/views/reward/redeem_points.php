...
<script src="<?php echo base_url('asset/zth-client/js/reward/redeem_points.js?_=' . TIME_NOW); ?>" type="text/javascript"></script>
...
<h1>
    <?php echo $this->lang->line('page_title_redeem'); ?>
</h1>
...
<div id="redeem_point_result" class="alert alert-danger" style="display:none;text-align:center;"></div>

<form id="redeem_point_form" class="card" style="display:none;" data-shop="<?php echo intval($access_workspace['id']); ?>">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    <div class="input-group input-group-lg">
                        ...
                        <input id="input_points_amount" name="points_amount" class="form-control form-control-lg" type="number" step="1" style="text-align:center;background-color:#fff;color:#3b5998;" value="0" onfocus="this.select();" onclick="this.select();">

                        <div class="input-group-addon">
                            <span><?php echo $this->lang->line('label_points_amount'); ?></span>
                        </div>

                    </div>
                </div>

                <div class="note_option_form row" style="display:none;">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="input_order_amount" name="order_amount" class="form-control" type="number" step="any" value="0" onfocus="this.select();" onclick="this.select();" style="text-align:center;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?php echo $this->lang->line('label_order_no'); ?></label>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-danger">
                        ...
                        <?php echo $this->lang->line('label_redeem_submit'); ?>
                    </button>
