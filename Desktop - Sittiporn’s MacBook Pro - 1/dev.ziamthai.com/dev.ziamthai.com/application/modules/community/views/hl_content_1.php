    ...
    <div class="col-lg-5">
        <div class="card bg-faded">
            <a href="<?php echo site_url('community/news/read'); ?>">
                <img src="<?php echo base_url('asset/zth-marketing/news/01.jpg'); ?>" class="img-fluid" style="width:100%;height:auto;box-shadow: 0 6px 12px -6px #222;">
            ...
            <?php for ($news_i = 0; $news_i < 4; $news_i++) { ?>
                <div class="col-xs-6">
                    <div style="height:90px;overflow:hidden;margin-bottom:10px;">
                        <a href="<?php echo site_url('community/news/read'); ?>">
                            <img src="<?php echo base_url('asset/zth-marketing/news/0' . ($news_i + 4) . '.jpg'); ?>" class="img-fluid" style="width:100%;height:auto;">
                        </a>
                    </div>
