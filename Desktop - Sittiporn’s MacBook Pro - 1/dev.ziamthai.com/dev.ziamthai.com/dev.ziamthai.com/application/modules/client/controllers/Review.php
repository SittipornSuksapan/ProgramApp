...
class Review extends CI_Controller {
    ...
    public function index() {
        $this->load->language($this->access_module . '/review/search');

        $this->template->set('title', $this->lang->line('page_title'));
        $this->template->set('sidebar_mnu_active', 'review_search');

        $this->template->view($this->access_module . '/review/search', array(
