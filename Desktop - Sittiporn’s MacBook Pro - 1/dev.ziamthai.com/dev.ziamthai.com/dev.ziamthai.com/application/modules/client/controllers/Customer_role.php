...
class Customer_role extends CI_Controller {
  ...
  public function index() {
    ...
    $this->load->model($this->access_module . '/business/Shop_model');
		...
		$this->template->set('sidebar_mnu_active', 'customer_role');
		$this->template->view($this->access_module . '/client/client_role', array(
