...
Class Oauth_model extends CI_Model {
    ...
    private $cols_selector = 'memh_id AS id,memh_display AS name,memh_firstname AS firstname,memh_lastname AS lastname,memh_email AS email,memh_level AS level,memh_activated AS activated,memh_status AS status';
    ...
    public function valid_user($provider) {
        ...
        $set_where[] = $this->oauth_memh_idn[$this->oauth_provider] . " LIKE '$idn'";

        if (isset($_SESSION[$this->oauth_provider . '_email'])) {
            $set_where[] = "memh_email LIKE '" . $_SESSION[$this->oauth_provider . '_email'] . "'";
        }
        ...
        $user_data = $this->check_user($query->row_array());
