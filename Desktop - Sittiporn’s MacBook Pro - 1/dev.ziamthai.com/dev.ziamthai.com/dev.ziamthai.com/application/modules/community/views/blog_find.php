...
<div class="container" style="margin-top:20px;">
    <ol class="breadcrumb bg-faded">
        ...
        if (empty($cate_title)) {
            $cate_title = 'Guide';
            echo '<li class="breadcrumb-item active">Guide</li>';
        } else {
            echo '<li class="breadcrumb-item"><a href="' . site_url('community/blog/find') . '">Guide</a></li>';
...
<div class="container" style="margin-top:5px;">
    ...
    <div class="col-md-8 col-lg-9" style="padding:0;">
        <div class="card" style="padding:15px;">
            ...
            <?php for ($blog_i = 0; $blog_i < 6; $blog_i++) { ?>
                <div class="container-fluid" style="margin-bottom:20px;">
                    <div class="col-lg-4" style="max-height:160px;overflow:hidden;">
                        <a href="<?php echo site_url('community/blog/read'); ?>">
                            <img src="<?php echo base_url('asset/zth-marketing/news/0' . ($blog_i + 2) . '.jpg'); ?>" class="img-fluid" style="width:100%;height:auto;">
                        </a>
                    </div>
