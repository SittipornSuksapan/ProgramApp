...
<style type="text/css">
    ...
    .photo_item_add,
    .photo_item_btn { display:inline-block;text-align:center;vertical-align:middle;width:100%;height:90px;padding:0px;overflow:hidden;background-position:center;background-repeat:no-repeat;background-size:contain; }
    .photo_item_btn img { width:100%;height:auto; }
    .photo_item_del { position:absolute;top:0;right:16px; }
</style>


<!-- Modal -->
<div class="modal fade" id="reviews_photo_modal" tabindex="-1" role="dialog">
    <form id="reviews_photo_form" class="modal-dialog" role="document" action="<?php echo base_url('api.php/v1/reviews/photo_upload'); ?>" target="reviews_photo_iframe" method="POST" enctype="multipart/form-data">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input id="reviews_photo_shop" type="hidden" name="shop" value="<?php echo $shop_info['id']; ?>">
