...
class Sales_order extends CI_Controller {
    ...
    public function index() {
        $this->load->language($this->access_module . '/sales_order/search');

        $this->template->set('title', $this->lang->line('page_title'));
        $this->template->set('sidebar_mnu_active', 'bill_order');

        $this->template->view($this->access_module . '/sales_order/search', array(
