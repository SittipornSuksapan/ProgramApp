...
public class Calories_ALL_Group extends BaseExpandableListAdapter {
	...
	public Calories_ALL_Group(ArrayList<HashMap<String, String>> al , ArrayList<ArrayList<HashMap<String, String>>> nodes) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		LinearLayout layouthead=(LinearLayout) convertView.findViewById(R.id.layouthead);
		if(groupPosition==0)
		{
		...
		String strdate=hashMapdata.get("Key1");
		String date=strdate.substring(6)+"/"+strdate.substring(4,6)+"/"+strdate.substring(0,4);
		text1.setText(date);
