...
public class Databasefa extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databasefaversstestss";

    // Table Name
    private static final String TABLE_NAME = "databasefaversstestsstable";

	public Databasefa(Context context) {
