...
public class Databasefa2 extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databasefaverlisttwo";

    // Table Name
    private static final String TABLE_NAME = "databasefaverlist1twotable";

	public Databasefa2(Context context) {
