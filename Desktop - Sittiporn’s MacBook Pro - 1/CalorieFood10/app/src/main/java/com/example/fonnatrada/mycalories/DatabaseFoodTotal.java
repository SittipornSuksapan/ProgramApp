...
public class DatabaseFoodTotal extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "foodedatatotal";

    // Table Name
    private static final String TABLE_NAME = "foodedatatotaltable";

	public DatabaseFoodTotal(Context context) {
