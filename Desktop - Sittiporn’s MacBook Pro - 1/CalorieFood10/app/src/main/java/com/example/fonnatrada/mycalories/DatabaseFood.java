...
public class DatabaseFood extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "foodedatatest";
 
    // Table Name
    private static final String TABLE_NAME = "foodedatatesttable";
	...
	public ArrayList<HashMap<String, String>> SelectAllDataInDate(String date,String userid) {
		// TODO Auto-generated method stub
		...
		try {
			...
			SQLiteDatabase db;
			db = this.getReadableDatabase(); // Read Data
			String strSQL = "SELECT  * FROM " + TABLE_NAME+" WHERE col1='"+userid+"' and col7='"+date+"' order by col9 asc";
		...
		public ArrayList<HashMap<String, String>> SelectAllData() {
			// TODO Auto-generated method stub
			 ...
			 try {
				 ...
				 calendarBefore.add(Calendar.DAY_OF_YEAR, -6);
				 Date newDate7 = calendarBefore.getTime();
				 //SimpleDateFormat formats = new SimpleDateFormat("yyyy/MM/dd, EEEE");
				 SimpleDateFormat formats = new SimpleDateFormat("yyyyMMdd");
				 final String strdate=formats.format(newDate7);
				 final String strdateNow=formats.format(datenow);
				 ArrayList<HashMap<String, String>> MyArrList = new ArrayList<HashMap<String, String>>();
				 HashMap<String, String> map;
				 SQLiteDatabase db;
				 db = this.getReadableDatabase(); // Read Data
				 //String strSQL = "SELECT  * FROM " + TABLE_NAME +" where substr(col7,0,4)||substr(col7,5,2)||substr(col7,8,2) between '"+strdate+"' and '"+strdateNow+"'";
                 String strSQL = "SELECT  * FROM " + TABLE_NAME +" where col7 between '"+strdate+"' and '"+strdateNow+"'";
