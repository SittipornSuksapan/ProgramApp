...
public class Databasefa1 extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "databasefaverlistone";

    // Table Name
    private static final String TABLE_NAME = "databasefaverlistonetable";

	public Databasefa1(Context context) {
